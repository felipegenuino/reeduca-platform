    ...
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 h-14 flex items-center gap-2.5 shrink-0">
        ...
        <div className="flex flex-col">
          <span className="font-semibold text-[15px] text-[hsl(var(--sidebar-foreground))] leading-tight">
            Reeduca Fisio
          </span>
          <span className="text-[10px] font-medium uppercase tracking-widest text-[hsl(var(--sidebar-muted))]">
            Admin
          </span>
        </div>
      </div>
